...
export default function TechnicianCreate() {
  ...
  const handleFormSubmit = React.useCallback(async () => {
    ...
    try {
      await createTechnician(formValues as Omit<technicianData, "id">);
      notifications.show("Technician created successfully.", {
        severity: "success",
      ...
      notifications.show(
        `Failed to create technician. Reason: ${(createError as Error).message}`,
        {
          severity: "error",
          autoHideDuration: 3000,
        }
